...
export function QuestionPreview() {
  return <div className="bg-card border border-border rounded-xl p-4 md:p-6 shadow-xl w-full max-w-md">
      {/* Header */}
  ...
  return <div className="bg-card border border-border rounded-xl p-4 md:p-6 shadow-xl w-full max-w-md">
      ...
      <div className="bg-muted/50 rounded-lg p-3">
        ...
        <div className="flex gap-1">
          {[true, true, true, false, false, false, false].map((done, i) => <div key={i} className={cn("h-2 flex-1 rounded-full", done ? "bg-success" : "bg-secondary")} />)}
        </div>
      </div>
    </div>;
}
...
export function PracticeModesPreview() {
  ...
  return <div className="bg-card border border-border rounded-xl p-4 shadow-xl w-full max-w-xs">
      <h3 className="text-sm font-semibold text-foreground mb-3">Practice Modes</h3>
      <div className="space-y-2">
        {modes.map(mode => <div key={mode.label} className="flex items-center gap-3 p-3 rounded-lg bg-secondary/50 hover:bg-secondary transition-colors cursor-pointer">
...
export function UIPreviewSection() {
  return <section className="py-16 px-4 bg-muted/30 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        duration: 0.5
          ...
          <h2 className="text-3xl md:text-4xl font-mono font-bold text-foreground mb-4">Built for the modern era</h2>
